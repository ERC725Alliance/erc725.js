...
export const LSP6_DEFAULT_PERMISSIONS = {
  // right bits range: [...] 0000 1111 1111 1111
  CHANGEOWNER:
  ...
  // left bits range: 1111 1000 0000 0000 [...]
  SUPER_SETDATA:
...
// all permissions above from the left + right bits range
export const LSP6_ALL_PERMISSIONS =
  '0xF800000000000000000000000000000000000000000000000000000000000FFF';
