...
import LSP1JSONSchema from '../../schemas/LSP1UniversalReceiverDelegate.json' with {
  type: 'json',
};
import LSP3JSONSchema from '../../schemas/LSP3ProfileMetadata.json' with {
  type: 'json',
};
import LSP4JSONSchema from '../../schemas/LSP4DigitalAsset.json' with {
  type: 'json',
};
import LSP4LegacyJSONSchema from '../../schemas/LSP4DigitalAssetLegacy.json' with {
  type: 'json',
};
import LSP5JSONSchema from '../../schemas/LSP5ReceivedAssets.json' with {
  type: 'json',
};
import LSP6JSONSchema from '../../schemas/LSP6KeyManager.json' with {
  type: 'json',
};
import LSP8JSONSchema from '../../schemas/LSP8IdentifiableDigitalAsset.json' with {
  type: 'json',
};
import LSP9JSONSchema from '../../schemas/LSP9Vault.json' with { type: 'json' };
import LSP10JSONSchema from '../../schemas/LSP10ReceivedVaults.json' with {
  type: 'json',
};
import LSP12JSONSchema from '../../schemas/LSP12IssuedAssets.json' with {
  type: 'json',
};
import LSP17JSONSchema from '../../schemas/LSP17ContractExtension.json' with {
  type: 'json',
};
