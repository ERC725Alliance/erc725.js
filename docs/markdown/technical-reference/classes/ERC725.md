...
[index.ts:108](https://github.com/ERC725Alliance/erc725.js/blob/51bcfc7/src/index.ts#L108)
...
[index.ts:66](https://github.com/ERC725Alliance/erc725.js/blob/51bcfc7/src/index.ts#L66)
...
[index.ts:398](https://github.com/ERC725Alliance/erc725.js/blob/51bcfc7/src/index.ts#L398)

___

### encodeData

▸ **encodeData**<`T`\>(`dataByKey`): { [K in string \| number \| symbol]: object}
...
| Name | Type |
| :------ | :------ |
| `dataByKey` | { [K in string \| number \| symbol]: Schema[T]["encodeData"]["inputTypes"]} |

#### Returns

{ [K in string \| number \| symbol]: object}

A key-value pair, containing the encoded values
...
[index.ts:342](https://github.com/ERC725Alliance/erc725.js/blob/51bcfc7/src/index.ts#L342)
...
[index.ts:249](https://github.com/ERC725Alliance/erc725.js/blob/51bcfc7/src/index.ts#L249)

___

### getData

▸ **getData**<`T`\>(`data?`): `Promise`<`any`\>
...
[index.ts:200](https://github.com/ERC725Alliance/erc725.js/blob/51bcfc7/src/index.ts#L200)
...
[index.ts:427](https://github.com/ERC725Alliance/erc725.js/blob/51bcfc7/src/index.ts#L427)
