...
| Name          | Type  | Description                                                        |
| :------------ | :---- | :----------------------------------------------------------------- |
| `decodedData` | Array | The decoded data as defined and expected in the following schemas. |
...
- If the input is an array, the values will be returned in an object under their key names.
- If the input is a single key, the output will be the value of the key.
...
/**
{
  ...
  'LSP12IssuedAssetsMap:cafecafecafecafecafecafecafecafecafecafe': '0x123...'
}
*/
```
