...
Checks if a signature is valid, according to [EIP-1271](https://eips.ethereum.org/EIPS/eip-1271) standard. It will will perform the check against the smart contract address provided at instantiation.

:::tip
The [LSP0 - ERC725Account](../../../standards/smart-contracts/lsp0-erc725-account.md) supports the EIP-1271 interface. You can use this function to check if an EOA has control over an ERC725Account.
:::
